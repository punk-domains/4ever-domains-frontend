...
export default {
  ...
  state: () => ({ 
    ...
    tldContract: null,
    tldChainId: 1313161555,
    tldChainName: "Aurora Testnet",
    minterAddress: "0x1B293F3fEdBB97cE6e17b3AB08723a942A5B774c", // TODO
    minterContract: null,
    minterPaused: true,
    minterTldPrice1: 0.01,
    minterTldPrice2: 0.005,
    minterTldPrice3: 0.001,
    minterTldPrice4: 0.0005,
